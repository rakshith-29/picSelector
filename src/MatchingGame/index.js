...
class MatchingGame extends Component {
  ...
  onClickPic = id => {
    const {activeImageId, isGameInProgress} = this.state

    const isCorrectPic = activeImageId.id === id
  ...
  renderPics = () => {
    const {activeImageId, activeTabId, seconds} = this.state
    const {imageUrl} = activeImageId
    const filteredPics = this.getFilteredPics()
    this.checkSeconds()

    return (
      <div className="when-game-on">
        <div className="display-image-container">
          <img src={imageUrl} alt="match" className="displayed-image" />
        </div>
        ...
        <ul className="pics-list">
          {filteredPics.map(eachPic => (
            <PictureItem
              key={eachPic.id}
              picDetails={eachPic}
              clickPic={this.onClickPic}
            />
          ))}
        </ul>
      </div>
  ...
  renderScoreCard = () => {
    ...
    return (
      <div>
        <div className="outline-score-card">
          <div className="score-card-container">
            <div className="trophy-score-container">
              <img
              ...
              >
                <div className="button-container">
                  <img
                    ...
                    className="reset-img"
                  />
                  <p className="play-again-img"> PLAY AGAIN </p>
                </div>
              </button>
            </div>
          </div>
  ...
  render() {
    ...
    const {imageUrl, category} = activeImageId
    ...
    return (
      <div className="app-container">
        ...
        {isGameInProgress ? this.renderPics() : this.renderScoreCard()}
      </div>
    )
  }
}
